...
import { GovGetProposalsType, GovGetVotingAtBlockType, GovSubmitVoteType, GovGetTokensVotingPower as GovGetPower, GovGetVoteOnProposal, Proposal, Power, ProposalRPC, Vote } from './types';
export declare const parseProposal: (rawProposal: ProposalRPC) => Promise<Proposal>;
